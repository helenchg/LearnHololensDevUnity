...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    /// </summary>
    [RequireComponent(typeof(SpatialMappingObserverNavMesh))]
    public partial class SpatialMappingManagerNavMesh : Singleton<SpatialMappingManagerNavMesh>
    {
        ...
        /// </summary>
        private SpatialMappingObserverNavMesh surfaceObserver;
        ...
        /// </summary>
        public SpatialMappingObserverNavMesh SurfaceObserver { get { return surfaceObserver; } }

        /// <summary>
        /// The current source of spatial mapping data.
        /// </summary>
        public SpatialMappingSourceNavMesh Source
        {
            get { return source; }
        ...
        private SpatialMappingSourceNavMesh source;

        /// <summary>
        /// Occurs when <see cref="Source" /> changes.
        /// </summary>
        public event EventHandler<PropertyChangedEventArgsEx<SpatialMappingSourceNavMesh>> SourceChanged;
        ...
        protected override void Awake()
        {
            ...
            surfaceObserver = gameObject.GetComponent<SpatialMappingObserverNavMesh>();
        ...
        public void SetSpatialMappingSource(SpatialMappingSourceNavMesh mappingSource)
        {
        ...
        public ReadOnlyCollection<SpatialMappingSourceNavMesh.SurfaceObject> GetSurfaceObjects()
        {
