        ...
        private void Update()
        {
            if ((ObserverState == ObserverStates.Running) && (outstandingMeshRequest == null))
            {
                if (surfaceWorkQueue.Count > 0)
                {
                    ...
                    NavMeshSourceTag navMeshSourceTag; // ADDED
                    ...
                    if (spareSurfaceObject == null)
                    {
                        ...
                        //navMeshSourceTag = newSurface.Object.AddComponent<NavMeshSourceTag>(); // ADDED
                    }
                    else
                    {
                        ...
                        //navMeshSourceTag = newSurface.Object.GetComponent<NavMeshSourceTag>(); // ADDED
                        //Debug.Assert(navMeshSourceTag != null); // ADDED
                    }
