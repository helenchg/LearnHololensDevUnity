...
{
    public class SpatialMappingSourceNavMesh : MonoBehaviour
    {
        /// <summary>
        /// Surface object
        /// </summary>
        ...
        /// </summary>
        protected virtual Material RenderMaterial { get { return SpatialMappingManagerNavMesh.Instance.SurfaceMaterial; } }
        ...
        public SpatialMappingSourceNavMesh()
        {
            ...
            )
        {
            ...
            surfaceObject.Object.transform.SetParent(parentObject);
            surfaceObject.Object.gameObject.AddComponent<NavMeshSourceTag>();

            surfaceObject.Object.layer = SpatialMappingManagerNavMesh.Instance.PhysicsLayer;
            ...
            surfaceObject.Renderer.enabled = (drawVisualMeshesOverride ?? SpatialMappingManagerNavMesh.Instance.DrawVisualMeshes);
            surfaceObject.Renderer.shadowCastingMode = ((castShadowsOverride ?? SpatialMappingManagerNavMesh.Instance.CastShadows) ? ShadowCastingMode.On : ShadowCastingMode.Off);
