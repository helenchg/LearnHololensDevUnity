...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    /// </summary>
    public enum ObserverStatesNavMesh
    {
        /// <summary>
    ...
    /// </summary>
    public enum ObserverVolumeTypesNavMesh
    {
        /// <summary>
    ...
    /// </summary>
    public class SpatialMappingObserverNavMesh : SpatialMappingSourceNavMesh
    {
        ...
        private ObserverVolumeTypesNavMesh observerVolumeType = ObserverVolumeTypesNavMesh.AxisAlignedBox;
        public ObserverVolumeTypesNavMesh ObserverVolumeType
        {
            get
            {
        ...
        public Quaternion Orientation
        {
            ...
            set
            {
                if (orientation != value)
                {
                    ...
                    if (ObserverVolumeType == ObserverVolumeTypesNavMesh.OrientedBox)
                    {
                        SwitchObservedVolume();
                    }
                }
        ...
        private void SwitchObservedVolume()
        {
            ...
            {
                case ObserverVolumeTypesNavMesh.AxisAlignedBox:
                    observer.SetVolumeAsAxisAlignedBox(origin, extents);
                    break;
                case ObserverVolumeTypesNavMesh.OrientedBox:
                    observer.SetVolumeAsOrientedBox(origin, extents, orientation);
                    break;
                case ObserverVolumeTypesNavMesh.Sphere:
        ...
        private void SurfaceObserver_OnDataReady(SurfaceData cookedData, bool outputWritten, float elapsedCookTimeSeconds)
        {
            ...
            outstandingMeshRequest.Value.Renderer.enabled = SpatialMappingManagerNavMesh.Instance.DrawVisualMeshes;
